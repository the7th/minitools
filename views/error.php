<section class="rounded-3xl border border-slate-800 bg-slate-900/60 p-8 shadow-2xl shadow-black/40">
    <p class="text-xs font-semibold uppercase tracking-[0.3em] text-red-400">Ralat</p>
    <h1 class="mt-3 text-3xl font-bold tracking-tight"><?= e($error ?? 'Ada sesuatu yang tak kena.') ?></h1>
